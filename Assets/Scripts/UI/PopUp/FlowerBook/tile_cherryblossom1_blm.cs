...

{
    ...
    public override Sprite FlowerIcon { get { _flowerIcon = GameManager.ResourceManager.Load<Sprite>($"Sprites/Flower_Icon/tile_cherryblossom1_blm"); return _flowerIcon; } set => throw new System.NotImplementedException(); }
